...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__calculate_js__ = __webpack_require__(10);
    ...
    wrap.addEventListener('click', function (e) {
        ...
        if (classNames.includes('btn')) {
            if (e.target.id === 'clear') {
                ...
                let result = new __WEBPACK_IMPORTED_MODULE_0__calculate_js__["a" /* Calculate */](data).getResult(); //4*(5-3)-2//12-16
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__js_index_js__ = __webpack_require__(0);


__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__js_index_js__["a" /* init */])();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__compute_js__ = __webpack_require__(11);
...
class Calculate {
    ...
    computeResult(num1, num2, opt) {
        let compute = new __WEBPACK_IMPORTED_MODULE_0__compute_js__["a" /* Compute */](num1, num2);
        switch (opt) {
            case '+':
                return compute.add();
                break;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Compute;
